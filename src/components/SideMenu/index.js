...
class SideMenu extends PureComponent {
    render() {
        ...
        const sideMenu = sideMenuSection.map( (element, index) => {
                             if(element.title !== undefined)
                                 ...
                                 return (
                                     <a  className={selectedElement !== element.subsectionName ? "side-menu-item" : "side-menu-item side-menu-item-selected"}
